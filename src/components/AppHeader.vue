  ...
  <nav class="immobilia-header">
    <div class="immobilia-header-content">
      <div class="immobilia-header-inner">
        ...
        >
          <RouterLink to="/" class="immobilia-nav-link"> Inicio </RouterLink>
          <RouterLink to="/proyectos" class="immobilia-nav-link">
            Proyectos
          </RouterLink>
          <RouterLink to="/agentes" class="immobilia-nav-link">
            Agentes
          </RouterLink>
          <RouterLink to="/contacto" class="immobilia-nav-link">
            Contacto
          </RouterLink>
          <RouterLink to="/blog" class="immobilia-nav-link"> Blog </RouterLink>
        </div>
